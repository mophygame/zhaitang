...
export type Property = { id:string; caseNumber:string; title:string; address:string; region:string; propertyType:string; price:number|null; layout:string; area:number; age:number; floor:string; direction:string; publicFacilities:string|null; parking:string; neighborHandling:string; anomalyLevel:string; status:string; handlerId:string; coverImage:string; beforeImage:string; afterImage:string; shortDescription:string; incidentSummary:string; pollutionBefore:number; pollutionAfter:number; stabilityBefore:number; stabilityAfter:number; spiritualActivityBefore:number; spiritualActivityAfter:number; contractIntegrityBefore:number; contractIntegrityAfter:number; handlingMethod:string; sealConsumption:string; finalDetermination:string; cautionNote:string; availableForSale:boolean; tags:string[]; completedAt:string; timeline:{date:string;event:string}[]; handlingStages:HandlingStage[] };
export type StaffCompanion = { name:string; kind:string; description:string };
export type StaffMember = { id:string; employeeNumber:string; name:string; englishName:string; title:string; department:string; ageDisplay:string; height:string; weight:string; personality:string; companion?:StaffCompanion; specialty:string[]; description:string; quote:string; portrait:string; caseCount:number; successRate:number; status:string; confidentialNote:string };
